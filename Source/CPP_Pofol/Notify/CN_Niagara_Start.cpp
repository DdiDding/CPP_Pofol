#include "Notify/CN_Niagara_Start.h"
#include "Components/CParticleManagerComponent.h"
#include "Util/CLog.h"

void UCN_Niagara_Start::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	pmc->Trail_Start(setSocketNames, effect);
}