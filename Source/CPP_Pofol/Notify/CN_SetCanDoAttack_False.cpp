#include "Notify/CN_SetCanDoAttack_False.h"
#include "Actors/Character/CCharacter.h"
#include "Components/CSkillManagerComponent.h"

void UCN_SetCanDoAttack_False::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
